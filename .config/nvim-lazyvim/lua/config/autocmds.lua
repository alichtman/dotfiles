...
vim.api.nvim_create_autocmd('FileType', {
    ...
    callback = function()
        ...
        -- vim.call('litecorrect#init()') -- TODO: This doesn't work
...
vim.api.nvim_create_autocmd('FileType', {
    ...
    callback = function()
        vim.api.nvim_set_keymap('n', '<leader>p', ':call mdip#MarkdownClipboardImage()<CR>',
...
-- vim.api.nvim_create_autocmd('BufEnter', {
    ...
    -- pattern = { '*' },
    -- callback = function()
        -- if vim.fn.winnr('$') == 1 and vim.b.NERDTree then
            -- vim.cmd('quit')
        -- end
    -- end
-- })
